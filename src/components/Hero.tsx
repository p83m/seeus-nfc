  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-electric-purple/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-electric-pink/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
          ...
          <div className="space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              <h1 className="text-6xl lg:text-8xl font-black tracking-tight">
                ...
                <span className="block text-white">Your Clients</span>
              </h1>
              <p className="text-xl lg:text-2xl text-white/90 font-medium max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8">
              <div className="text-center lg:text-left">
                ...
                <div className="text-sm text-white/80">Efekt WOW</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl font-bold text-white mb-2">🚀</div>
                <div className="text-sm text-white/80">Nowoczesna technologia</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl font-bold text-white mb-2">🎨</div>
                <div className="text-sm text-white/80">Personalizacja</div>
              </div>
            </div>
          </div>
